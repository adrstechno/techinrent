...
export default function EarnMoneyLinkedIn() {
  ...
  const seoData = {
    ...
    description:
      "Turn your LinkedIn account into passive income by renting your LinkedIn profile through TechInRent's secure platform.",
    about: {
      "@type": "Service",
  ...
  const earningFeatures = [
    {
      ...
      description:
        "Turn your LinkedIn account into a source of passive income with no upfront costs.",
    },
    {
      icon: TrendingUp,
      title: "Increase Social Capital",
      description:
        "Enhance your professional status by being part of an innovative sharing economy.",
    },
    {
      icon: Shield,
      title: "Secure and Confidential",
      description:
        "Your profile's security and privacy is our top priority with cutting-edge protection.",
    },
  ];
  ...
  const stepsToEarn = [
    {
      ...
      title: "Sign Up",
      description:
        "Register with our platform and complete your profile information.",
    },
    {
      step: 2,
      title: "Get Verified",
    ...
    },
    {
      ...
      title: "Start Earning",
      description:
        "Begin earning monthly revenue by renting your account to trusted professionals.",
    },
  ];
  ...
  const faqItems = [
    {
      ...
      answer:
        "Our platform uses advanced security measures to protect your account data and privacy.",
    },
    {
      question: "How do I receive payments?",
      answer:
        "Payments are distributed monthly via bank transfer, PayPal, or other preferred methods.",
    },
    {
      question: "Can I stop the rental service?",
      answer:
        "Yes, you have full control and can stop the rental service at any time.",
    },
  ];
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <p className="font-body text-lg md:text-xl text-gray-600 max-w-4xl mx-auto">
                Safe, secure, and completely passive - earn monthly income with
                zero effort.
              </p>
            </div>
        ...
        <div className="container mx-auto max-w-7xl">
          <div className="text-center mb-16">
            ...
            <p className="font-body text-lg text-gray-600 tracking-normal max-w-2xl mx-auto">
              Discover the benefits of partnering with the most trusted LinkedIn
 ...
 mb-8"
        ...
        <div className="bg-white border  rounded-2xl p-6 md:p-10 shadow-lg max-w-6xl mx-auto">
          ...
          <p className="text-gray-600 mb-6 leading-relaxed">
            Turn your professional LinkedIn account into a revenue-generating
            asset by renting it to verified businesses through our secure
            system.
          </p>
          ...
          <div className="text-center">
            <Button
              onClick={() => setIsProviderFormOpen(true)}
              className="bg-gradient-to-r cursor-pointer from-cyan-600 to-teal-600 hover:from-cyan-700 hover:to-teal-700 text-white px-6 py-3 rounded-lg text-lg font-medium transition duration-300"
            >
              Become a Provider
            </Button>
          </div>
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            ...
            <p className="font-body text-lg text-gray-600 tracking-normal max-w-2xl mx-auto">
              Get started with our straightforward process and begin earning
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-green-600 to-blue-600 text-white">
        <div className="container mx-auto text-center">
          ...
          <p className="font-body text-xl mb-8 opacity-90 tracking-normal">
            Join thousands who are already earning passive income with their
            LinkedIn accounts
          </p>
          <Button
            size="lg"
