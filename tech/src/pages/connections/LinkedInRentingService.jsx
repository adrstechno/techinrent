...
export default function LinkedInRentingService() {
  ...
  const seoData = {
    ...
    description:
      "Professional LinkedIn account renting service. Rent LinkedIn profiles for business networking and lead generation or earn money by providing your account.",
    ...
    offers: [
      ...
      },
      {
        ...
        description:
          "Access verified LinkedIn accounts for business outreach and lead generation",
      },
    ],
  };
  ...
  const benefits = [
    {
      ...
      description:
        "Access to premium, verified LinkedIn accounts with established networks and credibility.",
    },
    {
      icon: Shield,
      title: "100% Safe & Secure",
      description:
        "All accounts are thoroughly vetted and secure. Complete privacy protection guaranteed.",
    },
    {
      icon: Users,
      title: "Instant Network Access",
      description:
        "Get immediate access to thousands of industry connections and decision-makers.",
    },
    {
      icon: CheckCircle,
      title: "Industry-Specific Targeting",
      description:
        "Choose accounts tailored to your specific industry and target market for maximum impact.",
    },
  ];
  ...
  const howItWorks = [
    {
      ...
      description:
        "Select from our curated collection of verified LinkedIn accounts based on your industry and requirements.",
    },
    {
      number: "02",
      title: "Secure Rental Process",
      description:
        "Complete our secure rental process with flexible terms and transparent pricing.",
    },
    {
      number: "03",
      title: "Start Growing Your Network",
      description:
        "Begin leveraging your rented LinkedIn account to expand your professional network and generate leads.",
    },
  ];
  ...
  const testimonials = [
    {
      ...
      comment:
        "TechInRent's LinkedIn rental service transformed our lead generation. We saw a 300% increase in qualified leads within the first month.",
      rating: 5,
    },
    {
      name: "Michael Chen",
      role: "Sales Manager",
      comment:
        "The quality of LinkedIn accounts is exceptional. Professional, established profiles that immediately boosted our credibility.",
      rating: 5,
    },
    {
      ...
      comment:
        "Outstanding service and support. The rental process was seamless and the results exceeded our expectations.",
      rating: 5,
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
        ...
        <div className="container mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              TechInRent is the leading LinkedIn rental marketplace. Access
              verified LinkedIn accounts to dramatically increase your leads,
              expand your professional network, and accelerate your business
              growth.
            </p>
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12">
            Why Choose TechInRent LinkedIn Renting Service?
          </h2>
      ...
      <section className="py-16 px-4 bg-white/50">
        <div className="container mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12">
            How Our LinkedIn Rental Service Works
          </h2>
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12">
            What Our Users Say About TechInRent
          </h2>
          <div className="grid md:grid-cols-3 gap-8">
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Join thousands of businesses who trust TechInRent for professional
      ...
      <footer className="bg-gray-900 text-white py-12 px-4">
        <div className="container mx-auto">
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            &copy; 2024 TechInRent. All rights reserved. Leading LinkedIn
            renting service platform.
          </div>
        </div>
      </footer>
    </div>
