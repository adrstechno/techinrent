  ...
  const features = [
    {
      ...
      description:
        "Real-time LinkedIn connections delivered within 24-48 hours automatically with our fast delivery LinkedIn connections service",
    },
    {
      icon: <Shield className="w-6 h-6 text-blue-600" />,
      title: "Safe LinkedIn Connection Service",
      description:
        "How to get auto LinkedIn connections safely - all connections come from real, verified LinkedIn profiles with zero risk",
    },
    {
      icon: <TrendingUp className="w-6 h-6 text-blue-600" />,
      title: "Boost LinkedIn Profile Connections",
      description:
        "Increase LinkedIn popularity with connections to expand your professional reach and grow your LinkedIn network",
    },
    {
      icon: <Users className="w-6 h-6 text-blue-600" />,
      title: "Real LinkedIn Connections",
      description:
        "Buy targeted LinkedIn connections from verified professionals in your industry for authentic networking",
    },
    {
      icon: <Clock className="w-6 h-6 text-blue-600" />,
      title: "Auto LinkedIn Connection",
      description:
        "TechInRent auto LinkedIn connections processed instantly with real-time LinkedIn growth technology",
    },
    {
      icon: <CheckCircle className="w-6 h-6 text-blue-600" />,
      title: "TechInRent LinkedIn Boost",
      description:
        "Buy LinkedIn connections via crypto payment with 100% satisfaction guarantee from TechInRent",
    },
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        "Connections are typically delivered within 24-48 hours after purchase. Our automated system works around the clock to ensure fast delivery while maintaining the highest quality standards.",
    },
    {
      question: "Are these real LinkedIn profiles?",
      answer:
        "Yes, all connections come from real, verified LinkedIn profiles. We never use bots or fake accounts, ensuring your network growth is authentic and valuable.",
    },
    {
      question: "Is this service safe for my LinkedIn account?",
      answer:
        "Absolutely. Our methods comply with LinkedIn's terms of service, and we've helped thousands of professionals grow their networks safely. Your account security is our top priority.",
    },
    {
      question: "Can I target specific industries or locations?",
      answer:
        "Yes! Our premium plans include advanced targeting options to connect you with professionals in your desired industries, locations, and job functions.",
    },
    {
      question: "What payment methods do you accept?",
      answer:
        "We accept all major credit cards, PayPal, and cryptocurrency (USDT, BTC, ETH) for your convenience and privacy.",
    },
  ];
  ...
  return (
    ...
    >
      ...
      <header className="bg-white/90 backdrop-blur-sm border-b border-gray-200 sticky top-0 z-50">
        <div className="container mx-auto px-4 sm:px-6 py-1 flex justify-between items-center">
          ...
          <nav className="hidden md:flex items-center text-lg font-semibold gap-6">
            ...
            <a
              href="/"
              className="border px-4 py-2 rounded-md transition-all duration-300 
        ...
        {menuOpen && (
          <div className="md:hidden bg-white shadow-md border-t border-gray-200 px-4 py-4 space-y-4">
            ...
            <button
              ...
              className="w-full bg-blue-600 cursor-pointer text-white px-4 py-2 rounded-md hover:bg-blue-700 transition-colors duration-200"
            >
              Return
            </button>
          </div>
      ...
      <main className="relative container mx-auto px-4 sm:px-6 py-8">
          ...
          <Card className="bg-white border border-gray-200 shadow-xl rounded-2xl overflow-hidden max-w-6xl mx-auto relative">
            ...
            <CardHeader className="text-center pt-12 pb-8 px-6 sm:px-8">
              ...
              <CardDescription className="text-base sm:text-lg text-gray-600 max-w-3xl mx-auto">
                Purchase LinkedIn connections with{" "}
                <span className="font-medium text-blue-700">TechInRent</span>'s
                trusted service. Real, targeted, and secure – boost your
            ...
            <CardContent className="px-6 sm:px-8 pb-12">
              ...
              <Button
                ...
                disabled={isLoading}
                className="w-full max-w-md cursor-pointer mx-auto bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white py-4 text-base sm:text-lg font-semibold rounded-lg shadow-lg transition-all transform hover:scale-105 flex items-center justify-center"
              >
            ...
            {[
              ...
              <div key={index} className="relative">
                ...
                >
                  ...
                  {/* Content should flex-grow */}
                  <CardContent className="flex flex-col flex-grow px-6 sm:px-8 pb-6 sm:pb-8">
        ...
        <section
          className="bg-white border border-gray-100 p-6 sm:p-8 rounded-2xl shadow-inner mb-16 md:mb-20"
          id="how-it-works"
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 text-center">
            <div className="flex flex-col items-center gap-2">
              <div className="bg-blue-100 p-4 sm:p-5 rounded-full text-blue-600 font-bold text-xl sm:text-2xl">
                1
              </div>
            ...
            <div className="flex flex-col items-center gap-2">
              <div className="bg-purple-100 p-4 sm:p-5 rounded-full text-purple-600 font-bold text-xl sm:text-2xl">
                2
              </div>
              <p className="font-medium text-gray-700 text-sm sm:text-base">
                Submit details
              ...
              <p className="text-sm sm:text-base text-gray-500">
                Fill in your LinkedIn profile info securely.
              </p>
            </div>
            <div className="flex flex-col items-center gap-2">
              <div className="bg-green-100 p-4 sm:p-5 rounded-full text-green-600 font-bold text-xl sm:text-2xl">
                3
              </div>
              <p className="font-medium text-gray-700 text-sm sm:text-base">
                Start connecting
              ...
              <p className="text-sm sm:text-base text-gray-500">
                Watch your network grow within hours.
              </p>
            </div>
          </div>
        </section>
            ...
            {faqs.map((faq, index) => (
              <Card key={index} className="border-gray-200 transition-colors">
                <button
                  ...
                  className="w-full flex cursor-pointer items-center justify-between p-4 sm:p-6 text-left rounded-sm outline-none focus:outline-none focus:ring-0 focus:border-none"
                ...
                {activeFaq === index && (
                  <div
                    id={`faq-${index}`}
                    className="px-6 sm:px-8 mt-2 pb-6 text-sm sm:text-base text-gray-600"
                  >
                    {faq.answer}
                  </div>
                )}
          ...
          <Card className="bg-gradient-to-r from-blue-100 to-purple-100 rounded-2xl overflow-hidden">
            <CardContent className="p-8 sm:p-12 text-center text-blue-700">
              ...
              <p className="text-base sm:text-xl text-blue-600 max-w-2xl mx-auto mb-6 sm:mb-8">
                ...
                growth with TechInRent
              </p>
              <Button
                onClick={handleOrderClick}
                className="bg-white cursor-pointer text-blue-600 hover:bg-blue-50 px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-semibold rounded-lg shadow-lg"
              >
                <ShoppingCart className="w-4 h-4 sm:w-5 sm:h-5 mr-2" />
                Get Started Today
              </Button>
