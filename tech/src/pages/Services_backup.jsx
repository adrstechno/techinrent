...
Please send payment details.`;
  ...
  const seoData = {
    ...
    "description": "Professional LinkedIn services provider offering account rental, real connections, and lead generation solutions worldwide.",
    "sameAs": [
    ...
    "makesOffer": [
      {
        ...
        "priceSpecification": {
          ...
          "priceCurrency": "USD",
          "description": "Pricing based on demand - Contact vibhanshu@techinrent.com for custom quote"
        }
      },
      {
        "@type": "Offer",
        "name": "Real LinkedIn Connections",
        "description": "Buy authentic LinkedIn connections from targeted professionals in your industry",
        "category": "Professional Services",
        "priceSpecification": {
          "@type": "PriceSpecification",
          "priceCurrency": "USD",
      ...
      },
      {
        ...
        "description": "Custom lead generation solutions from our in-house team based on your requirements",
        "category": "Professional Services",
        "priceSpecification": {
          "@type": "PriceSpecification",
          "priceCurrency": "USD",
      ...
      "itemListElement": [
        {
          ...
          "item": {
            "@type": "Service",
            "name": "LinkedIn Account Rental",
            "description": "Access to verified LinkedIn accounts with established networks"
          }
        },
        {
          "@type": "ListItem",
  ...
  const services = [
    {
      ...
      description: "Access verified LinkedIn accounts with established networks and premium features for your business outreach campaigns.",
      features: [
    ...
    },
    {
      ...
      description: "Grow your LinkedIn network with authentic, targeted connections from professionals in your industry.",
      features: [
    ...
    },
    {
      ...
      description: "Custom lead generation solutions from our in-house team based on your specific business requirements.",
      features: [
  ...
  const benefits = [
    {
      ...
      description: "All our services comply with LinkedIn guidelines and use safe, proven methods."
    },
    {
      icon: Globe,
      title: "Worldwide Service",
      description: "We serve clients globally with 24/7 support and multilingual assistance."
    },
    {
      icon: Award,
      title: "Proven Results",
      description: "Over 150+ satisfied clients with measurable business growth and ROI."
    }
  ];
  ...
  const testimonials = [
    {
      ...
      comment: "TechInRent's LinkedIn services helped us generate 300% more qualified leads. Their approach is professional, targeted, and results-driven.",
      rating: 5,
    ...
    },
    {
      ...
      comment: "The LinkedIn account rental service gave us immediate access to a premium network. Highly recommend for B2B outreach campaigns.",
      rating: 5,
    ...
    },
    {
      ...
      company: "StartupXYZ",
      comment: "Buying real LinkedIn connections through TechInRent was the best investment for our networking strategy. Quality connections that actually engage.",
      rating: 5,
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
        ...
        <div className="container mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Comprehensive LinkedIn solutions to accelerate your business growth. From verified account access to custom lead generation, we provide everything you need to succeed on LinkedIn.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12">Our LinkedIn Services</h2>
          <div className="grid md:grid-cols-3 gap-8">
            {services.map((service, index) => (
              ...
              >
                <Card className={`h-full relative ${service.popular ? 'border-blue-500 border-2' : ''}`}>
                  {service.popular && (
                  ...
                  <CardHeader className="text-center">
                    ...
                    <div className="text-2xl font-bold text-blue-600 mt-4">{service.pricing}</div>
                  </CardHeader>
                  <CardContent>
                    ...
                    <Button
                      ...
                      onClick={() => {
                        if (service.title === "Buy Real Connections") {
                          document.getElementById('connection-pricing')?.scrollIntoView({ behavior: 'smooth' });
                        } else if (service.title === "LinkedIn Lead Generation") {
...
WhatsApp: ${userWhatsapp || 'Please provide WhatsApp'}`;
      ...
      <section id="connection-pricing" className="py-16 px-4 bg-gradient-to-br from-blue-50 to-indigo-50">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">LinkedIn Connection Pricing</h2>
            <p className="text-xl text-gray-600">Choose the perfect package for your networking needs</p>
          </div>
              ...
              >
                <Card
                  className={`text-center hover:shadow-lg transition-all cursor-pointer ${
                    connectionCount === tier.connections ? 'border-blue-500 border-2 bg-blue-50' : ''
                  }`}
                  onClick={() => setConnectionCount(tier.connections)}
                >
                  <CardContent className="p-4">
                    <div className="text-2xl font-bold text-blue-600 mb-2">{tier.label || tier.connections}</div>
                    <div className="text-sm text-gray-600 mb-2">{tier.connections} connections</div>
                    <div className="text-xl font-bold text-green-600">${tier.price}</div>
                  </CardContent>
                </Card>
              </motion.div>
            ))}
          ...
          <div className="max-w-2xl mx-auto">
            <Card className="p-6">
              <CardHeader className="text-center pb-4">
                ...
                <CardDescription>
                  Enter your details below and we'll send payment information via WhatsApp or email
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                ...
                <div>
                  <Label htmlFor="connection-count">Number of Connections *</Label>
                  <Input
                    id="connection-count"
                    type="number"
                    min="1"
                    ...
                    onChange={(e) => setConnectionCount(parseInt(e.target.value) || 50)}
                    className="mt-1"
                  />
                  <div className="text-sm text-gray-600 mt-1">
                    Current price: <span className="font-bold text-green-600">${calculatePrice(connectionCount)}</span>
                  </div>
                </div>
                <div>
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  ...
                  <div className="space-y-2 text-blue-700">
                    ...
                    <p className="text-sm">Payment details will be sent to your WhatsApp and email</p>
                  </div>
                </div>
                <Button
                  className="w-full"
                ...
                <div className="text-center text-sm text-gray-600">
                  Questions? Contact us at <a href="mailto:vibhanshu@techinrent.com" className="text-blue-600 hover:underline">vibhanshu@techinrent.com</a>
                </div>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="py-16 px-4 bg-white/50">
        <div className="container mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12">Why Choose Our LinkedIn Services?</h2>
          <div className="grid md:grid-cols-3 gap-8">
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white">
        <div className="container mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready to Grow Your LinkedIn Network?</h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Choose from our comprehensive LinkedIn services and start seeing results today
          </p>
