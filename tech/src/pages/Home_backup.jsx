    ...
    return (
      <div className="flex items-center justify-center h-screen bg-skyblue">
        <div className="text-center">
          <h2 className="font-heading text-2xl font-semibold text-primary mb-4 tracking-normal">Loading...</h2>
          <p className="font-body font-normal tracking-normal">Please select your user type on the welcome page.</p>
        </div>
      </div>
    );
  }
