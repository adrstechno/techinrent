...
import SchemaOrg from "@/components/provider/SchemaOrg";
...
export default function ProviderDashboard() {
  ...
  const dashboardSeoData = {
    ...
    description:
      "Manage your LinkedIn account rental, track earnings, and update your profile settings.",
    mainEntity: {
    ...
    <div className="container mx-auto p-4 sm:p-6">
      ...
      >
        ...
        <p className="text-gray-600 mt-2">
          Manage your LinkedIn profile rental settings and activity
        </p>
      </motion.div>
          ...
          <CardContent className="flex flex-col items-center pt-6">
            ...
            <div className="mt-6 space-y-1 w-full">
              ...
              <Button
                variant="ghost"
                className={`w-full justify-start ${
                  activeTab === "earnings" ? "bg-primary/10 text-primary" : ""
                }`}
              ...
              <Button
                variant="ghost"
                className={`w-full justify-start ${
                  activeTab === "rentals" ? "bg-primary/10 text-primary" : ""
                }`}
              ...
              <Button
                variant="ghost"
                className={`w-full justify-start ${
                  activeTab === "support" ? "bg-primary/10 text-primary" : ""
                }`}
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            ...
            <TabsContent value="profile" className="mt-0">
              <CardHeader>
                ...
                <CardDescription>
                  Update and manage your LinkedIn profile details
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ProviderProfile />
            ...
            <TabsContent value="earnings" className="mt-0">
              <CardHeader>
                ...
                <CardDescription>
                  Track your earnings from LinkedIn profile rentals
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="text-center p-12">
                  <p className="text-gray-500">
                    Earnings data will appear here once your profile is rented.
                  </p>
                </div>
              </CardContent>
            </TabsContent>
            <TabsContent value="rentals" className="mt-0">
              <CardHeader>
                ...
                <CardDescription>
                  View and manage your active profile rentals
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="text-center p-12">
            ...
            <TabsContent value="support" className="mt-0">
              <CardHeader>
                ...
                <CardDescription>
                  Get help with your account and profile rentals
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <ul className="mt-2 space-y-2">
                      <li className="text-sm text-blue-600 underline cursor-pointer">
                        How do rentals work?
                      </li>
                      <li className="text-sm text-blue-600 underline cursor-pointer">
                        How do I get paid?
