...
export default function SecureFormAdmin() {
  ...
  const { data: allFormsData = [], isLoading: isLoadingForms } = useQuery({
    queryKey: ["all-forms"],
    queryFn: () =>
      apiRequest("GET", "https://tech-in-rent.onrender.com/api/forms"),
  });
  ...
  const createUrlMutation = useMutation({
    ...
    onSuccess: (data) => {
      ...
      // Scroll the banner into view for visibility
      setTimeout(() => {
        try {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {newUrl && showNewUrlBanner && (
          <div ref={newUrlBannerRef}>
            <div className="mb-6 rounded-xl border-2 border-blue-400 bg-blue-50/80 shadow-md p-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex gap-2 w-full">
                    <Input
                      ...
                      className="flex-1 bg-white font-mono text-xs md:text-sm"
                    />
      ...
      >
        <DialogContent>
          ...
          <p className="text-sm text-amber-600 mt-2">
            <strong>Important:</strong> This URL can only be used once. Save it
