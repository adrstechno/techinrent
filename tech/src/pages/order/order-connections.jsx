...
export default function OrderConnectionsPage() {
    ...
    onSuccess: (data) => {
      ...
      if (paymentDone === "yes") {
        ...
        const orderDetails = {
          ...
          connections:
            selectedPackageData?.label.split(" ")[0] || selectedPackage,
        ...
        toast({
          ...
          description:
            "Your order has been successfully submitted. Redirecting to success page...",
        });
        setTimeout(() => {
  ...
  const uploadMutation = useMutation({
    mutationFn: async ({ orderId, screenshot }) => {
      ...
      const response = await fetch(
        `http://localhost:5001/api/orders/${orderId}/upload`,
        {
          method: "POST",
          body: formData,
        }
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-purple-800 relative overflow-hidden mobile-scroll-optimize">
      <SEO
        ...
        structuredData={{
          ...
          description:
            "Secure checkout page for purchasing real LinkedIn connections with cryptocurrency payments",
          provider: {
            "@type": "Organization",
            name: "TechInRent",
      ...
      <div className="container mx-auto px-4 py-12 sm:py-20">
        <header className="bg-white/90 backdrop-blur-sm border-b border-gray-200 sticky top-0 z-50 mb-12">
          <div className="container mx-auto px-4 py-4 flex justify-between items-center">
            ...
            <div className="flex items-center gap-4">
              <Button
                variant="outline"
                onClick={() => (window.location.href = "/buy-connections")}
              >
        ...
        <h1 className="text-2xl sm:text-4xl font-bold text-center text-white mb-12">
          Order Your LinkedIn Connections
        </h1>
          ...
          <Card className="bg-gradient-to-r from-white/95 to-white/90 backdrop-blur-lg border border-white/30">
            <CardHeader>
              ...
              <CardDescription className="text-gray-600">
                Fill in your details to place your order for LinkedIn
                connections
              </CardDescription>
            </CardHeader>
          ...
          <div className="space-y-8">
              ...
              <CardContent>
                ...
                <div className="mt-6 p-4 bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl">
                  ...
                  <p className="text-sm text-blue-600 mt-2 mb-4">
                    For bulk orders or custom packages, negotiate directly with
                    our team
                  </p>
                  <Button
                      ...
                      {selectedPayment === method.id && (
                        <div className="mt-4 p-3 bg-gray-100 rounded-lg">
                          ...
                          <div className="flex items-center gap-2 mt-2">
                            ...
                            <Button
                              onClick={() =>
                                copyToClipboard(method.address, method.network)
                              }
                              variant="outline"
                              size="sm"
                            >
            ...
            <Card className="bg-gradient-to-r from-white/95 to-white/90 backdrop-blur-lg border-2 border-white/40 shadow-2xl">
              <CardHeader>
                ...
                <CardDescription className="text-gray-600">
                  Have you completed the payment using the selected method
                  above?
                </CardDescription>
              </CardHeader>
              <CardContent>
                ...
                {paymentDone === "yes" && (
                  <div className="mt-4 p-4 bg-gradient-to-r from-green-100 to-emerald-100 rounded-xl">
                    ...
                    <p className="text-sm text-green-600">
                      After submitting your order, you'll be able to upload your
          ...
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            <Card className="bg-gradient-to-r from-white/95 to-white/90 backdrop-blur-lg border-2 border-white/40 shadow-2xl max-w-md w-full">
              <CardHeader className="text-center">
                ...
                <CardDescription className="text-gray-600">
                  Please upload your payment screenshot to complete the
              ...
              <CardContent className="space-y-6">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  ...
                  <p className="text-sm text-blue-700">
                    Uploading the payment screenshot is required to complete
                    your order. Our team will review and process your order
                    within 24 hours.
                  </p>
                </div>
            ...
            <Card className="bg-gradient-to-r from-white/95 to-white/90 backdrop-blur-lg border-2 border-white/40 shadow-2xl max-w-md w-full">
              ...
              <CardContent className="space-y-6">
                ...
                {paymentDone === "yes" && (
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    <p className="text-sm text-blue-700">
                      Payment confirmed. Your payment screenshot has been
                      uploaded and will be verified by our team.
                    </p>
                  </div>
                )}
                {paymentDone === "no" && (
