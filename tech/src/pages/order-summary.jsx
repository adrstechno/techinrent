...
export default function OrderSummaryPage() {
    ...
    onSuccess: (data) => {
      ...
      if (paymentDone === 'yes') {
        ...
        const orderDetails = {
          ...
          connections: selectedPackage?.value.split(' ')[0] || selectedPackage?.value,
  ...
  const handleOrderSubmit = () => {
    ...
    const orderData = {
      ...
      connectionCount: selectedPackage?.label.split(' ')[0] || '',
          ...
          <div className="space-y-8">
            ...
            <Card className="bg-gradient-to-r from-purple-500 to-indigo-500 text-white border-0 sticky top-8">
              ...
              <CardContent className="space-y-4">
                ...
                >
                  {isLoading ? "Submitting..." : `Submit Order - $${selectedPackage?.price || '0'}`}
                </Button>
