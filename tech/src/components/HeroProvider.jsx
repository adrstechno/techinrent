              ...
              >
                ...
                <div className="mt-3 p-4 bg-white rounded-lg border border-blue-200">
                  <p className="text-gray-700 font-medium">
                    <span className="text-blue-600 font-bold">$500+ MONTHLY PAYMENT</span> directly into your account for each approved LinkedIn profile
                  </p>
                ...
                <div className="mt-3 text-sm text-gray-700 italic">
                  *Payments begin immediately after account verification and approval
                </div>
              </motion.div>
              ...
              <motion.div variants={fadeIn} className="mt-8">
                ...
                <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="bg-white p-4 rounded-lg shadow-md relative overflow-hidden">
                    ...
                    <h4 className="font-semibold mb-2 relative z-10">Earn Monthly</h4>
                    <p className="text-sm text-gray-600 relative z-10">
                      <span className="font-bold text-blue-600">$500+</span> Monthly payment direct payment for each LinkedIn account
                    </p>
                  </div>
                </div>
              </motion.div>
