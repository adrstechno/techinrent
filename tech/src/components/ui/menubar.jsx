...
import { Menu, Group, Portal, Sub, RadioGroup, Root, Trigger, SubTrigger, SubContent, Content, Item, CheckboxItem, ItemIndicator, RadioItem, Label, Separator } from "@radix-ui/react-menubar"
...
const MenubarSubTrigger = forwardRef(({ className, inset, children, ...props }, ref) => {
  return createElement(SubTrigger, {
    ref: ref,
    className: cn(
...
const MenubarSubContent = forwardRef(({ className, ...props }, ref) => {
  return createElement(SubContent, {
    ref: ref,
    className: cn(
...
const MenubarCheckboxItem = forwardRef(({ className, children, checked, ...props }, ref) => {
  return createElement(CheckboxItem, {
    ref: ref,
    className: cn(
  ...
  }, createElement(ItemIndicator, null,
    createElement(Check, {
      className: "h-4 w-4"
    })
  )), children)
...
const MenubarRadioItem = forwardRef(({ className, children, ...props }, ref) => {
  return createElement(RadioItem, {
    ref: ref,
    className: cn(
      "relative flex cursor-default select-none items-center rounded-sm py-1.5 pl-8 pr-2 text-sm outline-none focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
      className
