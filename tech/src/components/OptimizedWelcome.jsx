...
// import {
//   Mail, Phone, MessageSquare, Instagram, Twitter, Linkedin, Send
// } from "lucide-react";
...
//     {/* Email */}
//     <a href="mailto:vibhanshu@techinrent.com" className="block group" target="_blank" rel="noopener noreferrer">
...
//         <p className="text-gray-700 text-2xs font-medium break-all">vibhanshu@techinrent.com</p>
//       </div>
//     </a>

//     {/* WhatsApp */}
//     <a href="https://wa.me/917898711748" className="block group" target="_blank" rel="noopener noreferrer">
...
//     {/* Telegram */}
//     <a href="https://t.me/Techinrentlinkedin" className="block group" target="_blank" rel="noopener noreferrer">
...
//     {/* Twitter/X */}
//     <a href="https://x.com/techinrent" className="block group" target="_blank" rel="noopener noreferrer">
...
//     {/* Instagram */}
//     <a href="https://instagram.com/techinrent" className="block group" target="_blank" rel="noopener noreferrer">
...
import { ServiceStructuredData, FAQStructuredData } from "@/components/ServiceSchema";
import {
  LogIn, Rocket, Link2, DollarSign, Shield, HelpCircle, 
  Users, UserPlus, BarChart2, TrendingUp, BadgeCheck,
  Mail, Phone, MessageSquare, Instagram, Twitter, Linkedin, Send,
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 md:py-16 text-center flex flex-col items-center justify-center min-h-[calc(100vh-80px)] safe-area-inset">
        ...
        <div className="mb-12 w-full flex flex-col items-center space-y-8">
          ...
          <div className="text-center space-y-4 max-w-4xl mx-auto">
            ...
            <p className="font-body text-lg sm:text-xl text-white/90 font-normal leading-relaxed tracking-normal">
              No login required • 24-48hr delivery • 100% secure process • Verified professionals
            </p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto space-y-12 px-4">
          ...
          <div className="bg-gradient-to-r from-white/95 to-white/90 backdrop-blur-lg rounded-3xl p-8 md:p-12 shadow-2xl border-2 border-white/40">
            <h2 className="font-heading text-2xl md:text-3xl lg:text-4xl font-bold text-transparent bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text mb-8 text-center tracking-tight">
              <Rocket className="inline-block w-8 h-8 mb-1 mr-2" /> LinkedIn Growth Services
            </h2>
            <p className="font-body text-gray-700 mb-10 text-lg leading-relaxed text-center max-w-4xl mx-auto tracking-normal">
              At TechInRent, we empower professionals, businesses, and agencies to grow and scale faster on LinkedIn — the world's #1 B2B social network. 
              Whether you're building authority, generating leads, or expanding your digital footprint, our LinkedIn growth services are designed to give you an edge — fast, safe, and hassle-free.
      ...
      <li>Discreet and secure – no account access needed</li>
          ...
          <div className="bg-white/95 backdrop-blur-lg rounded-3xl p-8 md:p-12 shadow-2xl border-2 border-white/40">
            <h2 className="font-heading text-2xl md:text-3xl font-bold text-transparent bg-gradient-to-r from-orange-500 to-red-500 bg-clip-text mb-12 text-center tracking-tight">
              <Shield className="inline-block w-7 h-7 mb-1 mr-2" /> Why Choose TechInRent?
            </h2>
          ...
          <div className="bg-gradient-to-r from-white/95 to-white/90 backdrop-blur-lg rounded-3xl p-8 md:p-12 shadow-2xl border-2 border-white/40">
            <h2 className="font-heading text-2xl md:text-3xl font-bold text-transparent bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text mb-8 text-center tracking-tight">
              <MessageSquare className="inline-block w-7 h-7 mb-1 mr-2" /> Contact Us
            </h2>
