...
import { BookDemoForm } from "../provider/BookDemoForm";
    ...
    if (userType === "taker") {
      return (
        <div>
          ...
          >
            Unlock high-quality LinkedIn profiles to accelerate your lead
            generation, sales, or recruitment efforts — all without putting your
            own account at risk.
          </motion.p>
          ...
          >
            <Button
              ...
              className="flex cursor-pointer items-center justify-center px-5 py-2.5 rounded-xl 
          ...
          <motion.div variants={fadeIn} className="mt-8">
            ...
            <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-white p-4 rounded-lg shadow-md text-center">
                ...
                <p className="text-sm text-gray-600">
                  You earn passive income monthly
                </p>
              </div>
            </div>
          </motion.div>
      ...
      return (
        <div className="text-center">
          ...
          <motion.p variants={fadeIn} className="text-lg text-gray-700 mb-8">
            Please select whether you're a LinkedIn Taker or Provider on the
            welcome page.
          </motion.p>
          <Button
