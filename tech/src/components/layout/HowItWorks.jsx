...
import { Search, CreditCard, Timer, ShieldCheck } from "lucide-react";
  ...
  const steps = [
    {
      ...
      title: "Browse & Select",
      description:
        "Choose from our verified LinkedIn accounts based on your industry and target audience needs.",
    ...
    },
    {
      ...
      description:
        "Complete your rental agreement with our secure payment system and flexible terms.",
    ...
    },
    {
      ...
      title: "Quick Access",
      description:
        "Get instant access to your rented LinkedIn account with full credentials and guidelines.",
    ...
    },
    {
      ...
      description:
        "Begin your campaigns immediately. Connect, engage, and grow your business fast with reliable LinkedIn profiles.",
          ...
          <div className="lg:col-span-2">
            ...
            >
              ...
              <p className="text-lg text-gray-700 max-w-2xl mx-auto lg:mx-0">
                Get started with our LinkedIn account rental service in just 4
                simple steps
              </p>
            </motion.div>
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-gray-700 mt-1">
                    Our LinkedIn accounts are ready to help you reach your
                    growth targets. Most clients see results within the first
                    week of using our service.
                  </p>
                </div>
              </div>
            </motion.div>
