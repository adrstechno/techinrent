...
//     try {
//       await apiRequest("POST", "https://tech-in-rent.onrender.com/api/contact", data);
...
//               Join hundreds of businesses that have supercharged their lead
//               generation with our LinkedIn accounts
//             </p>
//           </div>
...
//               </div>
//               <h3 className="font-heading font-semibold text-lg mb-1 tracking-normal">
//                 Risk-Free
//               </h3>
...
//                 help you find the perfect LinkedIn accounts for your business
//                 needs.
//               </p>
...
//                                 General Inquiry
//                               </SelectItem>
//                               <SelectItem value="Account Rental Question">
//                                 Account Rental Question
//                               </SelectItem>
//                               <SelectItem value="Custom Solution Request">
...
const contactFormSchema = z.object({
  ...
  subject: z.string().min(1, "Please select a subject").trim(),
...
export default function Contact() {
  ...
  const onSubmit = async (data) => {
    setIsSubmitting(true);
    try {
      const response = await apiRequest("POST", "https://techinrent.onrender.com/api/get-in-touch", data);
    ...
    <section id="contact" className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.6 }}
          className="bg-white rounded-xl shadow-xl p-10 relative overflow-hidden"
        >
          <div className="absolute top-0 right-0 w-48 h-48 bg-blue-100/20 rounded-bl-full"></div>

          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-blue-700 mb-4 tracking-tight">
              Ready to Scale Your LinkedIn Outreach?
            </h2>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            >
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="bg-blue-100/50 rounded-full w-12 h-12 flex items-center justify-center mr-4">
                        ...
                        <FormItem>
                          ...
                          <FormControl>
                            <Input
                              placeholder="John Smith"
                              {...field}
                              className="w-full rounded-md border-gray-300 p-3 h-11"
                            />
                          </FormControl>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          >
                            <FormControl>
                              <SelectTrigger className="w-full rounded-md border-gray-300 p-3 h-11">
                                <SelectValue placeholder="Select a subject" />
                              </SelectTrigger>
                            </FormControl>
                            <SelectContent>
