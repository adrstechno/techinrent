      ...
      <DialogContent className="max-w-3xl overflow-y-auto max-h-[90vh]">
        <DialogHeader>
          ...
          <DialogDescription className="text-base text-center">
            Turn your professional profile into a revenue-generating asset. Earn guaranteed monthly payments for each approved account. Complete the form below to register as a provider.
          </DialogDescription>
        </DialogHeader>
                      ...
                      <FormControl>
                        ...
                        >
                          ...
                          <div className="flex items-center space-x-3 rounded-md border p-3">
                            ...
                            <label htmlFor="nonVerified" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
            ...
            >
                ...
                <div className="flex items-start gap-2">
                  <div className="rounded-full bg-purple-100 p-1 mt-0.5">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M20 6L9 17L4 12" stroke="#7c3aed" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                  </div>
                  <div>
              ...
              <div className="rounded-lg bg-gradient-to-r from-purple-600/10 to-indigo-600/10 p-4 border border-purple-100 mt-6">
                ...
                <p className="text-sm font-medium text-purple-800">
                  "I've been earning money every month with TechInRent for 6 months now. The payments are always on time, and my account is handled professionally. It's the easiest passive income I've ever made"
                </p>
